...
import { Level1_Modell_1 } from './seedFiles/introBeginner/svg/Level_1/Level1_Modell_1';
import { Level1_Modell_2 } from './seedFiles/introBeginner/svg/Level_1/Level1_Modell_2';
import { Level1_Modell_3 } from './seedFiles/introBeginner/svg/Level_1/Level1_Modell_3';
import { Level1_Modell_4 } from './seedFiles/introBeginner/svg/Level_1/Level1_Modell_4';
import { Level1_Modell_5 } from './seedFiles/introBeginner/svg/Level_1/Level1_Modell_5';
import { Level1_Modell_6 } from './seedFiles/introBeginner/svg/Level_1/Level1_Modell_6';
import { Level1_Modell_7 } from './seedFiles/introBeginner/svg/Level_1/Level1_Modell_7';
import { Level1_Modell_8 } from './seedFiles/introBeginner/svg/Level_1/Level1_Modell_8';
import { Level1_Modell_9 } from './seedFiles/introBeginner/svg/Level_1/Level1_Modell_9';
import { Level1_Modell_10 } from './seedFiles/introBeginner/svg/Level_1/Level1_Modell_10';
import { Level1_Modell_11 } from './seedFiles/introBeginner/svg/Level_1/Level1_Modell_11';

export default class SeedModellignQuestionBeginner implements Seeder {
    public async run(factory: Factory, connection: Connection): Promise<any> {


        let Modell_1 = new Level1_Modell_1();
        let Modell_2 = new Level1_Modell_2();
        let Modell_3 = new Level1_Modell_3();
        let Modell_4 = new Level1_Modell_4();
        let Modell_5 = new Level1_Modell_5();
        let Modell_6 = new Level1_Modell_6();
        let Modell_7 = new Level1_Modell_7();
        let Modell_8 = new Level1_Modell_8();
        let Modell_9 = new Level1_Modell_9();
        let Modell_10 = new Level1_Modell_10();
        let Modell_11 = new Level1_Modell_11();
        ...
        .values([
           {
            ...
            {
            // Level 1 Model 11
            modelling_rule_id:seedQsRule.identifiers[10].modelling_question_id,
            modelling_rule_text: Modell_11.getXML_EN(),
            modelling_rule_text_de: Modell_11.getXML_DE(), 
            modelling_rule_svg: Modell_11.getSVG_EN(),
            modelling_rule_svg_de: Modell_11.getSVG_DE()
            },
